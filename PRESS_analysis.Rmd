...
```{r combine TOC comparison plots fig.height=4, fig.width=8, message=FALSE, warning=FALSE}
...
curve.pivot %>% 
  ...
  geom_point(aes(fill = method), size = 2, shape = 21, alpha = 0.7) +
  geom_errorbar(aes(ymin = ave - sd, ymax = ave + sd, color = method), width = 0.1) +
